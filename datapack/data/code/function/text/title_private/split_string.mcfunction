...
execute if score $stringIndex string.math < $stringLength.plusone string.math run function code:text/title_private/split_string with storage tl:temp string